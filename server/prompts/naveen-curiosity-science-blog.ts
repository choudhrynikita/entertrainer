export const CURIOSITY_SCIENCE_BLOG = `# Naveen Curiosity Science Blog (condensed)
...
Prefer: (1) recent peer-reviewed primary / systematic reviews, (2) official institutions, (3) qualified researcher talks cross-checked in writing, (4) reputable journalism for context only — never sole support for a central claim.

Check corrections, retractions, superseded work. Recency matters; quality and relevance still win.
...
5. **Thought experiment** — familiar setting + one rule changed + tension + scientific mechanism + philosophical consequence clearly marked as interpretation.
6. **Architecture**
...
- Present pop-neuroscience, quantum mysticism, personality stereotypes, or folklore as established science.
- Claim one study proves a universal law.
- Hide major limitations.
- Use a famous creator as substitute for evidence.
